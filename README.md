...
1. download the theme file, [`midnightmountains.theme.css`](https://github.com/Warzob/MidnightMountains/blob/main/midnight-Mountains.theme.css). (there should be a download button at the top right of the page)
